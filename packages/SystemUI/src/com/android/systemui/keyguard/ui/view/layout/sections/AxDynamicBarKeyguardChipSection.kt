...
constructor(
            ...
            repeatOnLifecycle(Lifecycle.State.CREATED) {
                combine(viewModel.isKeyguardExpanded, viewModel.isLowUdfps) { expanded, lowUdfps ->
                    ...
                    if (expanded) {
                        ...
                        lp.bottomMargin =
                            (EXPANDED_CHIP_BOTTOM_MARGIN_DP * context.resources.displayMetrics.density + 0.5f)
                                .toInt()
        ...
        constraintSet.apply {
            if (expanded) {
                ...
                val margin =
                    (EXPANDED_CHIP_BOTTOM_MARGIN_DP * context.resources.displayMetrics.density + 0.5f)
                        .toInt()
                connect(chipViewId, ConstraintSet.BOTTOM, R.id.start_button, ConstraintSet.TOP, margin)
    ...
    companion object {
        ...
        private const val EXPANDED_CHIP_BOTTOM_MARGIN_DP = 28f
    }
